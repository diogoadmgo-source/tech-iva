-- 0202_fix_register_credential_log_audit_cast.sql
-- Corrige o cast de entity_id na chamada de log_audit dentro de register_credential.
...
begin
  ...
  -- log_audit espera p_entity_id text: passar o uuid cru não casa com nenhuma
  -- assinatura e o upload falhava com "function log_audit(...) does not exist".
