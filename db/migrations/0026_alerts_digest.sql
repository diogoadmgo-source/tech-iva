-- 0026_alerts_digest.sql
-- Bloco 3.10 — preferências de alerta (tenants.settings->'alerts') e resumo semanal.
-- weekly_digest_batch só é executável por service_role (cron), nunca pelo browser.
