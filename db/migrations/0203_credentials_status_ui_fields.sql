-- 0203_credentials_status_ui_fields.sql (minha faixa começa em 0200)
-- O dado do certificado existia no banco e a tela não tinha como mostrar:
-- fingerprint, início da validade, finalidade do último uso e a confirmação de
-- titular ficavam fora do retorno de credentials_status.
