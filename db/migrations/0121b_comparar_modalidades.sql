-- 0121b_comparar_modalidades.sql — ESPELHO da migration aplicada no banco.
--
-- A modalidade virou premissa COMPARÁVEL: a empresa vai ter que escolher em 2027,
-- e comparar o efeito no caixa é a decisão que ela precisa tomar. Devolve os três
-- cenários com gap de 30/60/90 e a pior semana de cada, mais a observação com a fonte.
