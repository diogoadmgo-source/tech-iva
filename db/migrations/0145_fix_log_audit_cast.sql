-- 0145_fix_log_audit_cast.sql — ESPELHO da migration do Diogo (faixa 0140-0199).
-- register_credential chamava log_audit passando o uuid onde o parâmetro é text;
-- o Postgres não resolvia a sobrecarga e o upload falhava com
-- "function log_audit(uuid, unknown, unknown, uuid, unknown, jsonb) does not exist".
