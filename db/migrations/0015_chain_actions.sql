-- 0015 — Ação em lote da Carteira (T2): marcar contrapartes para renegociar.
-- alerts não tem policy de INSERT para authenticated; a criação passa por RPC
-- security definer com checagem de papel + audit_log.
