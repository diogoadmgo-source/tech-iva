-- 0022_fix_chain_map_ambiguity.sql
-- JÁ APLICADA MANUALMENTE NO BANCO (fluxa-dev) pelo mantenedor — arquivo espelho.
-- Correção do 0013: os OUT params de chain_map colidiam com colunas homônimas da CTE.
-- Solução: colunas da CTE renomeadas (prefixo b_) e todas as referências qualificadas.

create or replace function public.chain_map(
  p_tenant uuid, p_role party_role default 'customer'::party_role, p_filters jsonb default '{}'::jsonb)
