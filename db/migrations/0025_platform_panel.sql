-- 0025_platform_panel.sql
-- Bloco 3.9 — painel da plataforma (/rules e /ops). Aplicada por esta sessão.
-- Acesso: is_platform_ops() para leitura; is_platform_admin() para criar/publicar regra;
-- publicação real exige require_aal2(). Todas as funções com search_path = public, extensions.
