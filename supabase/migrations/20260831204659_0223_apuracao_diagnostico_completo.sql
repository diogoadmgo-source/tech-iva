-- 0223_apuracao_diagnostico_completo.sql
--
...
--    solicitação). Hoje só o download guarda diagnóstico, então uma recusa no
--    passo do token deixa apenas "HTTP 400" sem causa. Formato:
--       { "token": {status, ok, headers, corpo_recorte, em},
--         "solicitar": {status, ok, headers, corpo_recorte, em} }
--    Nunca carrega credencial nem access_token — só metadados da resposta.
--
