-- 0152: expõe ao front os dados de finalidade/autoria/falhas do certificado.

-- Lista fechada de finalidades, validada em trigger (não CHECK, para evoluir sem
-- recriar constraint).
...
-- register_credential passa a gravar finalidades + autoria. Parâmetros novos com
-- DEFAULT: chamadas antigas continuam válidas.
...
-- credentials_status devolve finalidades, contador de falhas e a autoria (quem
-- subiu e quando) — o cliente precisa ver isso quando alguém sobe por ele.
